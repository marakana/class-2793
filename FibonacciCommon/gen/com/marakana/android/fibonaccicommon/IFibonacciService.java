 ...
 * Original file: /Volumes/Home/Users/blake/Desktop/AdvancedAndroid/code/FibonacciCommon/src/com/marakana/android/fibonaccicommon/IFibonacciService.aidl
 */
...
{
data.enforceInterface(DESCRIPTOR);
com.marakana.android.fibonaccicommon.FibonacciRequest _arg0;
if ((0!=data.readInt())) {
_arg0 = com.marakana.android.fibonaccicommon.FibonacciRequest.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
com.marakana.android.fibonaccicommon.FibonacciResponse _result = this.fib(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
@Override public com.marakana.android.fibonaccicommon.FibonacciResponse fib(com.marakana.android.fibonaccicommon.FibonacciRequest req) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.marakana.android.fibonaccicommon.FibonacciResponse _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
if ((req!=null)) {
_data.writeInt(1);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.marakana.android.fibonaccicommon.FibonacciResponse.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public com.marakana.android.fibonaccicommon.FibonacciResponse fib(com.marakana.android.fibonaccicommon.FibonacciRequest req) throws android.os.RemoteException;
}
